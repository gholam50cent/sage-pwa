...
const STR = {
  ...
  tab_calendar: ["Calendario", "تقویم"],
  tab_history: ["Memorias", "تاریخچه"],
  tab_insights: ["Mi Mundo", "آمار"],
  active: ["AHORA", "فعال"],
  cycle_day: ["DÍA", "روز سیکل"],
  tap_below: ["Toca abajo para empezar", "برای شروع، دکمه را بزنید"],
  start_period: ["Empezar", "شروع پریود"],
  end_period: ["Terminar", "پایان پریود"],
  phase_menstrual: ["Mi Luna", "قاعدگی"],
  phase_follicular: ["Renacer", "فولیکولار"],
  phase_ovulation: ["Florecer", "تخمک‌گذاری"],
  phase_luteal: ["Espera", "لوتئال"],
  no_records: ["Sin memorias aún", "هنوز چیزی ثبت نشده"],
  tap_plus: ["Toca + para comenzar", "روی + بزنید تا اضافه کنید"],
  records: ["memorias", "مورد"],
  record_single: ["memoria", "مورد"],
  ongoing: ["en curso", "در حال انجام"],
  days: ["días", "روز"],
  ended: ["terminó", "پایان"],
  delete_record: ["Borrar", "حذف رکورد"],
  delete_confirm: ["Esto no se puede deshacer. ¿Estás segura?", "این عمل قابل بازگشت نیست. مطمئن هستید؟"],
  delete: ["Borrar", "حذف"],
  cancel: ["No, gracias", "انصراف"],
  new_record: ["Nueva Memoria", "افزودن رکورد"],
  edit_record: ["Editar", "ویرایش رکورد"],
  start_date: ["INICIO", "تاریخ شروع"],
  end_date: ["FIN", "تاریخ پایان"],
  notes: ["Mis Notas", "یادداشت"],
  add_notes: ["Añade notas...", "یادداشت اضافه کنید..."],
  save: ["Guardar", "ذخیره"],
  clear: ["Limpiar", "حذف"],
  next_period: ["PRÓXIMA LUNA", "پریود بعدی"],
  in_days: ["en", "تا"],
  today: ["hoy", "امروز"],
  days_ago: ["días atrás", "روز پیش"],
  stat_records: ["Memorias", "تعداد"],
  stat_avg_cycle: ["Ciclo promedio", "میانگین سیکل"],
  stat_avg_duration: ["Duración promedio", "میانگین مدت"],
  stat_completed: ["COMPLETADO", "تکمیل شده"],
  high: ["Alto", "بالا"],
  medium_acc: ["Medio", "متوسط"],
  low: ["Bajo", "پایین"],
  very_low: ["Muy bajo", "بسیار پایین"],
  day_details: ["Mi Día", "جزئیات روز"],
  period_day: ["Día de luna", "روز پریود"],
  flow: ["FLUJO", "شدت خونریزی"],
  flow_none: ["Ninguno", "ندارد"],
  flow_light: ["Ligero", "کم"],
  flow_medium: ["Medio", "متوسط"],
  flow_heavy: ["Fuerte", "زیاد"],
  pain: ["DOLOR", "شدت درد"],
  mood: ["ESTADO", "حال و هوا"],
  mood_great: ["Excelente", "عالی"],
  mood_good: ["Bien", "خوب"],
  mood_okay: ["Normal", "معمولی"],
  mood_bad: ["Mal", "بد"],
  mood_awful: ["Terrible", "خیلی بد"],
  symptoms: ["SÍNTOMAS", "علائم"],
  sym_headache: ["Dolor de cabeza", "سردرد"],
  sym_cramps: ["Cólicos", "گرفتگی"],
  sym_fatigue: ["Fatiga", "خستگی"],
  sym_bloating: ["Hinchazón", "نفخ"],
  sym_nausea: ["Náusea", "تهوع"],
  sym_backache: ["Dolor de espalda", "کمردرد"],
  sym_breast: ["Sensibilidad", "حساسیت سینه"],
  sym_acne: ["Acné", "جوش"],
  sym_insomnia: ["Insomnio", "بی‌خوابی"],
  sym_cravings: ["Antojos", "هوس غذا"],
  settings: ["Mi Espacio", "تنظیمات"],
  appearance: ["APARIENCIA", "ظاهر"],
  theme_auto: ["Auto", "خودکار"],
  theme_light: ["Claro", "روشن"],
  theme_dark: ["Oscuro", "تاریک"],
  language: ["IDIOMA", "زبان"],
  lang_auto: ["Auto", "خودکار"],
  lang_english: ["English", "انگلیسی"],
  lang_persian: ["فارسی", "فارسی"],
  done: ["Listo", "تایید"],
  backup_restore: ["RESPALDO", "بکاپ و بازیابی"],
  create_backup: ["Descargar", "دانلود بکاپ"],
  create_backup_desc: ["Guardar tus datos", "ذخیره اطلاعات به‌صورت فایل"],
  restore_backup: ["Restaurar", "بازیابی از فایل"],
  restore_backup_desc: ["Elige un archivo", "انتخاب فایل بکاپ"],
  restore_confirm_title: ["¿Restaurar datos?", "بازیابی اطلاعات؟"],
  restore_confirm_desc: ["Esto reemplazará todos tus datos.", "این عمل اطلاعات فعلی را جایگزین می‌کند."],
  restore_success: ["Restaurado", "بازیابی موفق بود"],
  restore_failed: ["Error al restaurar", "بازیابی ناموفق: فرمت فایل نامعتبر"],
  cycle_day_short: ["Día", "روز"],
  symptom_overlap_title: ["CONEXIÓN", "هم‌پوشانی علائم"],
  predictability_title: ["CONSTANCIA", "پیش‌بینی‌پذیری سیکل"],
  less_predictable: ["Variable", "متغیر"],
  more_predictable: ["Constante", "ثابت"],
  cycles: ["ciclos", "سیکل"],
  install_app: ["Instalar", "نصب اپ"],
  fertility_window: ["MI VENTANA", "پنجره باروری"],
  ovulation_day: ["MI FLOR", "روز تخمک‌گذاری"],
  fertile_days: ["días fértiles", "روزهای باروری"],
  date_error: ["La fecha fin debe ser posterior", "تاریخ پایان باید بعد از شروع باشد"],
  duration_error: ["Máximo 14 días", "مدت پریود نباید بیشتر از ۱۴ روز باشد"],
  symptom_added: ["Añadido a tu día", "علامت به لاگ امروز اضافه شد"],
  change_pin: ["Cambiar PIN", "تغییر PIN"],
  pin_set_title: ["Crea tu PIN", "پین خود را بسازید"],
  pin_set_desc: ["Elige un PIN de 4 dígitos", "یک پین ۴ رقمی انتخاب کنید"],
  pin_confirm_title: ["Confirma tu PIN", "پین خود را تأیید کنید"],
  pin_verify_title: ["Introduce tu PIN", "پین خود را وارد کنید"],
  pin_enter_current: ["PIN actual", "پین فعلی"],
  pin_enter_new: ["Nuevo PIN", "پین جدید"],
  pin_confirm_new: ["Confirma nuevo PIN", "تأیید پین جدید"],
  pin_mismatch: ["Los PIN no coinciden", "پین‌ها یکسان نیستند"],
  pin_wrong: ["PIN incorrecto", "پین اشتباه است"],
  pin_changed: ["PIN actualizado", "پین تغییر کرد"],
  onboarding_next: ["Siguiente", "بعدی"],
  onboarding_start: ["Comenzar", "شروع"]
};
  ...
  var slides = [
    {
      ...
      title: 'Sayuri',
      subtitle: 'Tu compañera íntima',
      desc: 'Tu calendario personal, inteligente y privado.'
    },
    {
      ...
      title: 'Patrones',
      subtitle: 'Tu cuerpo, tu ritmo',
      desc: 'Aprende de tu cuerpo con inteligencia adaptativa.'
    },
    {
      ...
      title: 'Privacidad',
      subtitle: 'Solo tuya',
      desc: 'Protegida con PIN. Tus datos, tu espacio.'
    }
  ];
...
function render() {
  ...
  var subtitleText = currentLang === 1 ? 'هوش سیکل' : 'Tu Inteligencia Cíclica';
...
function renderCalendarTab(analysis, activePeriod) {
  ...
  var actionBtn = '';
  if (activePeriod) {
    actionBtn = '<button class="secondary-btn" onclick="endPeriod()">' + t('end_period') + '</button>';
  } else {
    actionBtn = '<button class="primary-btn" onclick="startPeriod()">' + t('start_period') + '</button>';
  }
...
function renderCalendarGrid(analysis) {
  ...
  var mname = currentLang===1 ? MONTH_NAMES_FA[displayJ.month-1] : MONTH_NAMES_EN[displayJ.month-1];
  var displayYear = displayJ.year;
  ...
  cells.forEach(function(d) {
    ...
    var jDay = gregorianToJalali(y, m+1, d).day;
...
function renderDayDetailModal() {
  ...
  var flowChips = flowLabels.map(function(lbl, i) {
    return '<div class="chip ' + (state._tempFlow===i?'selected':'') + '" onclick="state._tempFlow=' + i + ';renderModalOnly()">' + lbl + '</div>';
  }).join('');

  var painCells = '';
  for (var i=0;i<=10;i++) {
    var isCurrent = state._tempPain === i;
    painCells += '<div class="pain-cell ' + (isCurrent?'selected':'') + '" onclick="state._tempPain=' + i + ';renderModalOnly()">' + numStr(i) + '</div>';
  }

  var moodRow = MOOD_KEYS.map(function(k, i) {
    return '<div class="mood-item ' + (state._tempMood===i?'selected':'') + '" onclick="state._tempMood=state._tempMood===' + i + '?-1:' + i + ';renderModalOnly()">' +
      '<span class="sym">' + MOOD_SYMBOLS[i] + '</span><span class="lbl">' + t(k) + '</span>' +
    '</div>';
  }).join('');

  var symptomGrid = SYMPTOM_KEYS.map(function(k) {
    return '<div class="symptom-chip ' + (state._tempSymptoms.has(k)?'selected':'') + '" onclick="toggleSymptom(\'' + k + '\')">' + t(k) + '</div>';
  }).join('');
...
function renderSettingsModal() {
  ...
  var pinBtn = '<div class="action-row" onclick="startChangePin()">' +
