...
function renderSettingsModal() {
  ...
  return '<div class="modal-overlay" onclick="if(event.target===this)closeModal()">' +
    '<div class="modal-card">' +
      ...
      (deferredPrompt ? '<div class="action-row" onclick="installPWA()"><div class="t">' + t('install_app') + '</div><div class="d">Add to home screen</div></div>' : '') +
...
function installPWA() {
  if (!deferredPrompt) {
    showToast('Open in browser and tap Add to Home Screen', 'error');
    return;
  }
